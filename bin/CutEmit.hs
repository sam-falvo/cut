...
testRunner :: String -> [P.CutParsed] -> Clip
testRunner spec ns = Chunks $ (headers spec):(externs ns):(mainFunction ns):[]
...
headers :: String -> Clip
headers spec = Chunk $ S.pack $
            "/* Automatically generated by cutgen 2.6. */\n" ++
            "#include " ++ spec ++ "\n"
